...
// hardcoded to N5 server-side, and 'kana_write'/'kana_read' repurpose the
// column to hold the script ('hira'/'kata') instead. History should show
// "-" for these rather than a misleading level value.
export const QUIZ_TYPES_WITHOUT_LEVEL = new Set(['kana', 'kana_write', 'kana_read']);
